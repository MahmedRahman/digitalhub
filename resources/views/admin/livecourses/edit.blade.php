    ...
    <div class="container">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0">تعديل الدورة المباشرة</h5>
            </div>
            <div class="card-body">
                <form action="{{ route('admin.livecourses.update', $livecourse) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('name') is-invalid @enderror" 
                               id="name" name="name" value="{{ old('name', $livecourse->name) }}" required>
                        @error('name')
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('description') is-invalid @enderror" 
                                  id="description" name="description" rows="4">{{ old('description', $livecourse->description) }}</textarea>
                        @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('objectives') is-invalid @enderror" 
                                  id="objectives" name="objectives" rows="4">{{ old('objectives', $livecourse->objectives) }}</textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="url" class="form-control @error('video_url') is-invalid @enderror" 
                               id="video_url" name="video_url" value="{{ old('video_url', $livecourse->video_url) }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="url" class="form-control @error('material_url') is-invalid @enderror" 
                               id="material_url" name="material_url" value="{{ old('material_url', $livecourse->material_url) }}">
                        @error('material_url')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="url" class="form-control @error('powerpoint_url') is-invalid @enderror" 
                               id="powerpoint_url" name="powerpoint_url" value="{{ old('powerpoint_url', $livecourse->powerpoint_url) }}">
